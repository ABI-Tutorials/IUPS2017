...
**Tutors:** `David Nickerson <http://www.abi.auckland.ac.nz/people/d-nickerson>`_, `Soroush Safaei <http://www.abi.auckland.ac.nz/people/ssaf006>`_, `Duncan Bakke <http://www.abi.auckland.ac.nz/en/about/our-people/students/duncan-bakke.html>`_, and `Thor Besier <http://www.abi.auckland.ac.nz/people/t-besier>`_, `Auckland Bioengineering Institute <http://www.abi.auckland.ac.nz/>`_, University of Auckland, New Zealand.
...
The Physiome Project is an international effort to establish an open science framework for biophysically-based multiscale modelling, including the development of standards, tools, and databases. The standards include `CellML <https://cellml.org/>`_, `SED-ML <http://sed-ml.org>`_, and `FieldML <http://fieldml.org>`_. The software includes `OpenCOR <http://www.opencor.ws/>`_, `OpenCMISS <http://www.opencmiss.org>`_, and `MAP Client <https://map-client.readthedocs.io/en/latest/>`_. A database of models is available at the `Physiome Model Repository (PMR) <https://models.physiomeproject.org/>`_.
